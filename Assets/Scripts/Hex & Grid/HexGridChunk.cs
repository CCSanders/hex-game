...
public class HexGridChunk : MonoBehaviour {
	...
	public HexMesh terrain, rivers, roads, water, waterShore, estuaries, politicalBorders;
    ...
    //this method takes a cell and the direction of the cell that needs to be triangulated.
    //it then gets the center vertex and the vertices of the cell at the edge of the solid factor in the direction specified
    //then, depending on some of the cell conditions, the correct triangulation method is chosen. 
	void Triangulate (HexDirection direction, HexCell cell) {
        ...
        //only need to triangulate the connections of cells on the first three directions
        ...
        if (cell.WithinCity)
        {
            TriangulatePoliticalBorder(direction, cell, e);
        }
	}
	...
	void TriangulateCorner (
		...
		if (leftEdgeType == EdgeType.Slope) {
            ...
            TriangulatePoliticalBorderCorner(bottom, bottomCell, left, leftCell, right, rightCell);
		}
    ...
    //method name is misleading. this triangulates the centers of our cells. 
    ...
    void TriangulatePoliticalBorderCorner(Vector3 bottom, HexCell bottomCell, Vector3 left, HexCell leftCell, Vector3 right, HexCell rightCell)
    {
